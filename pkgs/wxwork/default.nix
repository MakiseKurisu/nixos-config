# Imported from https://github.com/DzmingLi/nur-packages/blob/main/pkgs/wxwork/linux.nix
# due to https://github.com/DzmingLi/nur-packages/issues/3
...
buildFHSEnv {
  ...
  meta = {
    ...
    # lie here instead of working around allowUnfree from callPackage
