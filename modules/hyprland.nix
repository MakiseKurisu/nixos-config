      ...
      wayland.windowManager.hyprland = {
        ...
        settings = {
          ...
          windowrule = [
            ...
            "stay_focused yes, match:class ^(Pinentry)$, match:title ^(.*)$"
            ...
            "workspace 10 silent, match:class ^(flutterplugins\.exe)$, match:title ^()$"
            "workspace 10 silent, match:class ^(wemail\.exe)$, match:title ^(WeMail)$"
            "workspace 10 silent, match:class ^(wxwork\.exe)$, match:title ^()$"
            ...
            "workspace 18 silent, match:class ^(wxwork\.exe)$, match:title ^(企业微信)$"
