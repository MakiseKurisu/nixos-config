...

{
  ...
  nix.extraOptions = ''
    ...
    e = https://mirrors.ustc.edu.cn/nix-channels/store https://mirrors.tuna.tsinghua.edu.cn/nix-channels/store https://mirrors.sjtug.sjtu.edu.cn/nix-channels/store https://cache.nixos.org
  '';
